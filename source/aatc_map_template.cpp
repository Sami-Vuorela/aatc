...
template<> void aatc_register_container<aatc_CONTAINERTYPE::MAP>(asIScriptEngine* engine, aatc_Initializer* initializer){
	...
	//aatc_container_map_template::Register_iterator(engine, n_iterator, n_container_T);
	//aatc_container_map_template::aatc_iterator::Register(engine, n_iterator, n_container_T);
