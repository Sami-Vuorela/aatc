		...
		namespace usertype {
			...
			template<typename T_container> struct Container : public CUserType {
				...
				void Store(CSerializedValue* val_root, void* ptr) {
					tagfunc_Store<T_container::container_tags::is_map>(val_root, ptr);
				}
				void Restore(CSerializedValue* val_root, void* ptr) {
					tagfunc_Restore<T_container::container_tags::is_map>(val_root, ptr);
				}
				void CleanupUserData(CSerializedValue* val) {
					tagfunc_CleanupUserData<T_container::container_tags::is_map>(val);
				}

				template<typename tag_insertfunc> void tagfunc_1tp_insert(T_container* container, void* item){};
				template<> void tagfunc_1tp_insert<container::shared::tag::serializer_insert_value_func::insert>(T_container* container, void* item) {
					container->container.insert(item);
				}
				template<> void tagfunc_1tp_insert<container::shared::tag::serializer_insert_value_func::push_back>(T_container* container, void* item) {
					container->container.push_back(item);
				}

				template<typename tag_is_map> void tagfunc_Store(CSerializedValue* val_root, void* ptr) {}
				template<> void tagfunc_Store<container::shared::tag::is_map::is_not_map>(CSerializedValue* val_root, void* ptr) {
				...
				template<> void tagfunc_Store<container::shared::tag::is_map::is_map>(CSerializedValue* val_root, void* ptr) {
					container::shared::container_basicbase* container_base = (container::shared::container_basicbase*)ptr;
				...
				template<typename tag_is_map> void tagfunc_Restore(CSerializedValue* val_root, void* ptr) {}
				template<> void tagfunc_Restore<container::shared::tag::is_map::is_not_map>(CSerializedValue* val_root, void* ptr) {
					container::shared::container_basicbase* container_base = (container::shared::container_basicbase*)ptr;
					...
					if (container_template) {
						...
						if (container_template->handlemode) {
							...
							for (std::size_t i = 0; i < size; i++) {
								...
								tagfunc_1tp_insert<T_container::container_tags::serializer_insert_value_func>(container_template, serialized_object);
				...
				template<> void tagfunc_Restore<container::shared::tag::is_map::is_map>(CSerializedValue* val_root, void* ptr) {
					container::shared::container_basicbase* container_base = (container::shared::container_basicbase*)ptr;
					T_container* container = dynamic_cast<T_container*>(container_base);
				...
				template<typename tag_is_map> void tagfunc_CleanupUserData(CSerializedValue* val) {}
				template<> void tagfunc_CleanupUserData<container::shared::tag::is_map::is_not_map>(CSerializedValue* val) {
